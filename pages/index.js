...
<a href="https://twitter.com/sambarrowclough" target="_blank" class="badge">
                ...
                x.name && (
                  <div key={i}>
                    ...
                    {x && x.svg && (
                      <button
                        onClick={copyIcon}
                        className="hover:scale-125 outline-none transform transition-all hover:bg-gray-100 rounded ml-1 mb-1 p-2 flex items-center focus:outline-none focus:ring focus:border-blue-300"
